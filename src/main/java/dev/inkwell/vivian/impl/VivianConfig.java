...
package dev.inkwell.vivian.impl;
...
import dev.inkwell.oliver.api.serialization.PropertiesSerializer;
import dev.inkwell.oliver.api.util.Version;
...
public class VivianConfig extends Config<Map<String, String>> implements Stylable  {
    @Override
