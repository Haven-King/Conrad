...
public class Packets {
	public static void registerServerListeners() {
		ServerSidePacketRegistry.INSTANCE.register(ConfigInfoPacket.ID, ConfigInfoPacket::acceptOnServer);
	...
	public static void registerClientListeners() {
		ClientSidePacketRegistry.INSTANCE.register(ConfigInfoPacket.ID, ConfigInfoPacket::acceptOnClient);
	}
}
