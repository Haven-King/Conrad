...
import dev.hephaestus.clothy.gui.entries.DoubleListListEntry;
...
public class DoubleListBuilder extends FieldBuilder<List<Double>, DoubleListListEntry> {
    ...
    private Function<List<Double>, Optional<List<Text>>> tooltipSupplier = list -> Optional.empty();
    ...
    public DoubleListBuilder setTooltipSupplier(Function<List<Double>, Optional<List<Text>>> tooltipSupplier) {
        this.tooltipSupplier = tooltipSupplier;
        return this;
    }
    
    public DoubleListBuilder setTooltipSupplier(Supplier<Optional<List<Text>>> tooltipSupplier) {
        this.tooltipSupplier = list -> tooltipSupplier.get();
        return this;
    }
    
    public DoubleListBuilder setTooltip(Optional<List<Text>> tooltip) {
