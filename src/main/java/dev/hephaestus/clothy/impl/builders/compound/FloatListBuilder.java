...
public class FloatListBuilder extends FieldBuilder<List<Float>, FloatListListEntry> {
    ...
    private Function<List<Float>, Optional<List<Text>>> tooltipSupplier = list -> Optional.empty();
    ...
    public FloatListBuilder setTooltipSupplier(Supplier<Optional<List<Text>>> tooltipSupplier) {
        this.tooltipSupplier = list -> tooltipSupplier.get();
        return this;
    }
    
    public FloatListBuilder setTooltipSupplier(Function<List<Float>, Optional<List<Text>>> tooltipSupplier) {
        this.tooltipSupplier = tooltipSupplier;
        return this;
    }

    public FloatListBuilder setTooltip(Optional<List<Text>> tooltip) {
