...
public class StringListEntry extends TextFieldListEntry<String> {
    public StringListEntry(Text fieldName, String value, Text resetButtonKey, Supplier<String> defaultValue, Consumer<String> saveConsumer, @Nullable Function<String, Optional<List<Text>>> tooltipSupplier, boolean requiresRestart) {
